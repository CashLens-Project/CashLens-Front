...
const bundle = {
  sales: [
    ...
    { id: "S-1014", date: "2025-09-18", channel: "loja2",     netRevenue: 3500, taxes: 350, discounts: 150 }, // divergente
    { id: "S-1015", date: "2025-09-28", channel: "loja1",     netRevenue: 4000, taxes: 400, discounts: 200 }, // sem repasse
    // OUTUBRO 2025
  ...
  // Payouts: Setembro com 1 divergente, 1 sem repasse e 1 repasse sem venda
  payouts: [
    // MAIO
    { id: "P-7001", date: "2025-05-03", method: "CARD", netValue: 1800, fee: 20, saleId: "S-1001" },
    { id: "P-7002", date: "2025-05-12", method: "PIX",  netValue: 2500, fee:  0, saleId: "S-1002" },
    { id: "P-7003", date: "2025-05-26", method: "CARD", netValue: 1200, fee: 15, saleId: "S-1003" },
    // JUNHO
    { id: "P-7004", date: "2025-06-07", method: "PIX",  netValue: 3200, fee:  0, saleId: "S-1004" },
    { id: "P-7005", date: "2025-06-17", method: "CARD", netValue: 4500, fee: 40, saleId: "S-1005" },
    { id: "P-7006", date: "2025-06-29", method: "PIX",  netValue: 1500, fee:  0, saleId: "S-1006" },
    // JULHO
    { id: "P-7007", date: "2025-07-04", method: "CARD", netValue: 3800, fee: 25, saleId: "S-1007" },
    { id: "P-7008", date: "2025-07-20", method: "PIX",  netValue: 5200, fee:  0, saleId: "S-1008" },
    { id: "P-7009", date: "2025-07-26", method: "CARD", netValue: 2100, fee: 12, saleId: "S-1009" },
    // AGOSTO (100% conciliado)
    { id: "P-7010", date: "2025-08-09", method: "PIX",  netValue: 6800, fee:  0, saleId: "S-1010" },
    { id: "P-7011", date: "2025-08-22", method: "CARD", netValue: 3100, fee: 20, saleId: "S-1011" },
    { id: "P-7012", date: "2025-08-30", method: "PIX",  netValue: 2500, fee:  0, saleId: "S-1012" },
    // SETEMBRO
    { id: "P-7013", date: "2025-09-07", method: "CARD", netValue: 7200, fee: 50, saleId: "S-1013" }, // ok
    { id: "P-7014", date: "2025-09-19", method: "PIX",  netValue: 3400, fee:  0, saleId: "S-1014" }, // divergente (3500 vs 3400)
    // S-1015 sem repasse
    { id: "P-7099", date: "2025-09-15", method: "CARD", netValue: 1234, fee: 10, saleId: "S-NO-SALE" }, // repasse sem venda
    // OUTUBRO
    { id: "P-7016", date: "2025-10-06", method: "CARD", netValue: 15000, fee: 200, saleId: "S-1016" },
    { id: "P-7017", date: "2025-10-16", method: "PIX",  netValue: 8000,  fee:   0, saleId: "S-1017" },
    { id: "P-7018", date: "2025-10-21", method: "CARD", netValue: 3000,  fee:  30, saleId: "S-1018" },
  ],
};
